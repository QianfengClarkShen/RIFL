################################################################
# This is a generated script based on design: traffic_loopback_board2
################################################################
...
set design_name traffic_loopback_board2

create_bd_design $design_name

# Hierarchical cell: debug_core
proc create_hier_cell_debug_core { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_debug_core() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RIFL, and set properties
  set RIFL [ addip RIFL RIFL ]

  # Create instance: debug_core
  create_hier_cell_debug_core [current_bd_instance .] debug_core
  ...
  # Create instance: tx_rx_cross_domain, and set properties
  set tx_rx_cross_domain [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 tx_rx_cross_domain ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net clk100 [get_bd_intf_ports clk100] [get_bd_intf_pins init_clk_buf1/CLK_IN_D]
  connect_bd_intf_net -intf_net RIFL_m_axis [get_bd_intf_pins RIFL/m_axis] [get_bd_intf_pins rx_buffer/s_axis]
  connect_bd_intf_net -intf_net RIFL_rifl_gt [get_bd_intf_ports rifl_gt] [get_bd_intf_pins RIFL/rifl_gt]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins RIFL/s_axis] [get_bd_intf_pins tx_rx_cross_domain/M_AXIS]
  connect_bd_intf_net -intf_net gt_ref_clk [get_bd_intf_ports gt_ref] [get_bd_intf_pins RIFL/gt_ref_clk]
  connect_bd_intf_net -intf_net rx_buffer_m_axis [get_bd_intf_pins tx_rx_cross_domain/S_AXIS] [get_bd_intf_pins rx_buffer/m_axis]

  # Create port connections
  connect_bd_net -net RIFL_rx_clk [get_bd_pins RIFL/rx_clk] [get_bd_pins tx_rx_cross_domain/s_axis_aclk] [get_bd_pins rx_buffer/clk]
  connect_bd_net -net RIFL_rx_rst [get_bd_pins RIFL/rx_rst] [get_bd_pins rx_rstn/Op1] [get_bd_pins rx_buffer/rst]
  connect_bd_net -net RIFL_tx_clk [get_bd_pins RIFL/tx_clk] [get_bd_pins tx_rx_cross_domain/m_axis_aclk]
  connect_bd_net -net RIFL_tx_rst [get_bd_pins RIFL/tx_rst] [get_bd_pins tx_rstn/Op1]
  connect_bd_net -net init_clk_buf1_IBUF_OUT [get_bd_pins init_clk_buf1/IBUF_OUT] [get_bd_pins init_clk_buf2/BUFG_I]
  connect_bd_net -net init_clk_buf2_BUFG_O [get_bd_pins RIFL/init_clk] [get_bd_pins init_clk_buf2/BUFG_O] [get_bd_pins reset_controller/clk]
  connect_bd_net -net reset_controller_probe_out0 [get_bd_pins RIFL/gt_rst] [get_bd_pins reset_controller/probe_out0]
  connect_bd_net -net reset_controller_probe_out1 [get_bd_pins RIFL/rifl_rst] [get_bd_pins reset_controller/probe_out1]
  connect_bd_net -net rx_rstn_Res [get_bd_pins rx_rstn/Res] [get_bd_pins tx_rx_cross_domain/s_axis_aresetn]
  connect_bd_net -net tx_rstn_Res [get_bd_pins tx_rstn/Res] [get_bd_pins tx_rx_cross_domain/m_axis_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces debug_core/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs debug_core/debug_bridge_0/S_AXI/Reg0] SEG_debug_bridge_0_Reg0
