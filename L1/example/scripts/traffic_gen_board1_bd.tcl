################################################################
# This is a generated script based on design: traffic_gen_board1
################################################################
...
set design_name traffic_gen_board1

create_bd_design $design_name

# Hierarchical cell: AXIDMAs
proc create_hier_cell_AXIDMAs { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_AXIDMAs() - Empty argument(s)!"}
     return
  }
  ...
  set axi_dma_1 [ addip axi_dma axi_dma_1 ]
  set_property -dict [ list \
   CONFIG.c_addr_width {64} \
  ...
  set xlconcat_0 [ addip xlconcat xlconcat_0 ]
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_1/S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins interconnect_aresetn] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_1/S02_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dout] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins slowest_sync_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_1/S02_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
...
proc create_hier_cell_software { parentCell nameHier } {
  ...
  # Create instance: AXIDMAs
  create_hier_cell_AXIDMAs $hier_obj AXIDMAs
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AXIDMAs_M00_AXI [get_bd_intf_pins AXIDMAs/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins AXIDMAs/M_AXI_S2MM]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins AXIDMAs/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins AXIDMAs/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins AXIDMAs/S_AXI_LITE1] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins M_AXI] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins debug_bridge_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net AXIDMAs_dout [get_bd_pins AXIDMAs/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net AXIDMAs_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins AXIDMAs/interconnect_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins debug_bridge_0/s_axi_aresetn]
  connect_bd_net -net M02_ACLK_1 [get_bd_pins M02_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK]
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins M02_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins pl_clk0] [get_bd_pins AXIDMAs/slowest_sync_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins pl_resetn0] [get_bd_pins AXIDMAs/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
...
proc create_hier_cell_SD_traffic_gen { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.CMP_FIFO_DEPTH {2048} \
   CONFIG.DATAWIDTH {14} \
   CONFIG.DWIDTH {112} \
   CONFIG.EN_LOOPBACK {true} \
 ] $SD_AXIS_traffic_gen_0
  ...
  # Create instance: traffic_ila, and set properties
  set traffic_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 traffic_ila ]
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_3_INTF_TYPE {clarkshen.com:user:SD_AXIS_dbg_rtl:1.0} \
 ] $traffic_ila
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn7] [get_bd_intf_pins from_app] [get_bd_intf_pins traffic_ila/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins to_app] [get_bd_intf_pins SD_AXIS_traffic_gen_0/to_app]
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn8] [get_bd_intf_pins to_app] [get_bd_intf_pins traffic_ila/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net SD_AXIS_traffic_gen_0_debug_ports [get_bd_intf_pins SD_AXIS_traffic_gen_0/debug_ports] [get_bd_intf_pins traffic_ila/SLOT_3_SD_AXIS_DBG]
  connect_bd_intf_net -intf_net SD_AXIS_traffic_gen_0_reference [get_bd_intf_pins SD_AXIS_traffic_gen_0/reference] [get_bd_intf_pins traffic_ila/SLOT_2_AXIS]
  ...
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins traffic_clk_rstn] [get_bd_pins software/M02_ARESETN] [get_bd_pins traffic_ila/resetn]
  ...
  connect_bd_net -net software_pl_resetn0 [get_bd_pins pl_resetn0] [get_bd_pins software/pl_resetn0]
  connect_bd_net -net traffic_clk_1 [get_bd_pins traffic_clk] [get_bd_pins SD_AXIS_traffic_gen_0/traffic_clk] [get_bd_pins software/M02_ACLK] [get_bd_pins traffic_ila/clk]
...
proc create_root_design { parentCell } {
  ...
  set clk100 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 clk100 ]
  ...
  # Create instance: RIFL_0, and set properties
  set RIFL_0 [ addip RIFL RIFL_0 ]

  # Create instance: SD_traffic_gen
  create_hier_cell_SD_traffic_gen [current_bd_instance .] SD_traffic_gen

  # Create instance: axis_clock_converter_0, and set properties
  set axis_clock_converter_0 [ addip axis_clock_converter axis_clock_converter_0 ]

  # Create instance: init_clk_buf1, and set properties
  set init_clk_buf1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 init_clk_buf1 ]

  # Create instance: init_clk_buf2, and set properties
  set init_clk_buf2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 init_clk_buf2 ]
  set_property -dict [ list \
  ...
  set reset_controller [ create_bd_cell -type ip -vlnv xilinx.com:ip:vio:3.0 reset_controller ]
  set_property -dict [ list \
  ...
  # Create instance: rifl_stats_ila, and set properties
  set rifl_stats_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 rifl_stats_ila ]
  set_property -dict [ list \
   CONFIG.C_BRAM_CNT {6} \
   CONFIG.C_SLOT_0_INTF_TYPE {clarkshen.com:user:rifl_stats_rtl:1.0} \
 ] $rifl_stats_ila

  # Create instance: rx_buffer, and set properties
  set rx_buffer [ create_bd_cell -type ip -vlnv clarkshen.com:user:zero_latency_axis_fifo:1.0 rx_buffer ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {112} \
  ...
  connect_bd_intf_net -intf_net CLK_IN_D_0_1 [get_bd_intf_ports clk100] [get_bd_intf_pins init_clk_buf1/CLK_IN_D]
  connect_bd_intf_net -intf_net DDR_C0_DDR4_0 [get_bd_intf_ports C0_DDR4_0] [get_bd_intf_pins memory/C0_DDR4_0]
  connect_bd_intf_net -intf_net RIFL_0_m_axis [get_bd_intf_pins RIFL_0/m_axis] [get_bd_intf_pins rx_buffer/s_axis]
  connect_bd_intf_net -intf_net RIFL_0_rifl_gt [get_bd_intf_ports rifl_gt] [get_bd_intf_pins RIFL_0/rifl_gt]
connect_bd_intf_net -intf_net RIFL_0_rifl_stats [get_bd_intf_pins RIFL_0/rifl_stats] [get_bd_intf_pins rifl_stats_ila/SLOT_0_RIFL_STATS]
  connect_bd_intf_net -intf_net SD_traffic_gen_to_app [get_bd_intf_pins RIFL_0/s_axis] [get_bd_intf_pins SD_traffic_gen/to_app]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins SD_traffic_gen/from_app] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net gt_ref_clk_0_1 [get_bd_intf_ports gt_ref] [get_bd_intf_pins RIFL_0/gt_ref_clk]
  connect_bd_intf_net -intf_net rx_buffer_m_axis [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins rx_buffer/m_axis]
  ...
  connect_bd_net -net RIFL_0_rx_clk [get_bd_pins RIFL_0/rx_clk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins rx_buffer/clk]
  connect_bd_net -net RIFL_0_rx_rst [get_bd_pins RIFL_0/rx_rst] [get_bd_pins rx_buffer/rst] [get_bd_pins rx_rstn/Op1]
  connect_bd_net -net RIFL_0_tx_clk [get_bd_pins RIFL_0/tx_clk] [get_bd_pins SD_traffic_gen/traffic_clk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
  connect_bd_net -net rx_rstn_Res [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins rx_rstn/Res]
  connect_bd_net -net traffic_clk_rst_1 [get_bd_pins RIFL_0/tx_rst] [get_bd_pins SD_traffic_gen/traffic_clk_rst] [get_bd_pins tx_rstn/Op1]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins RIFL_0/init_clk] [get_bd_pins init_clk_buf2/BUFG_O] [get_bd_pins reset_controller/clk] [get_bd_pins rifl_stats_ila/clk]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT1 [get_bd_pins init_clk_buf1/IBUF_OUT] [get_bd_pins init_clk_buf2/BUFG_I]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins SD_traffic_gen/traffic_clk_rstn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins tx_rstn/Res]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins RIFL_0/gt_rst] [get_bd_pins reset_controller/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins RIFL_0/rifl_rst] [get_bd_pins reset_controller/probe_out1]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0030000 [get_bd_addr_spaces SD_traffic_gen/software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SD_traffic_gen/SD_AXIS_traffic_gen_0/s_axilite_ctrl/reg0] SEG_SD_AXIS_traffic_gen_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0010000 [get_bd_addr_spaces SD_traffic_gen/software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SD_traffic_gen/software/AXIDMAs/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0020000 [get_bd_addr_spaces SD_traffic_gen/software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SD_traffic_gen/software/AXIDMAs/axi_dma_1/S_AXI_LITE/Reg] SEG_axi_dma_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces SD_traffic_gen/software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SD_traffic_gen/software/debug_bridge_0/S_AXI/Reg0] SEG_debug_bridge_0_Reg0
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SD_traffic_gen/software/AXIDMAs/axi_dma_0/Data_SG] [get_bd_addr_segs SD_traffic_gen/software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SD_traffic_gen/software/AXIDMAs/axi_dma_0/Data_MM2S] [get_bd_addr_segs SD_traffic_gen/software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SD_traffic_gen/software/AXIDMAs/axi_dma_0/Data_S2MM] [get_bd_addr_segs SD_traffic_gen/software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SD_traffic_gen/software/AXIDMAs/axi_dma_0/Data_SG] [get_bd_addr_segs SD_traffic_gen/software/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SD_traffic_gen/software/AXIDMAs/axi_dma_0/Data_MM2S] [get_bd_addr_segs SD_traffic_gen/software/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SD_traffic_gen/software/AXIDMAs/axi_dma_0/Data_S2MM] [get_bd_addr_segs SD_traffic_gen/software/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
